...
<script type="text/javascript">
	//在页面加载成功的时候 将下拉选回显
	$(function(){
		//获取指定的option标签,添加selected属性
		$("#custSourceId option[value='${custSource.dictId}']").attr("selected",true);
		$("#custLevelId option[value='${custLevel.dictId}']").attr("selected",true);
		$("#custIndustryId option[value='${custIndustry.dictId}']").attr("selected",true);
	})
</script>
</HEAD>
<BODY>
